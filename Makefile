...
test: all
	...
	./holycc $(TESTDIR)/test3.holyc -t $(TESTDIR)/test3.out 2> $(TESTDIR)/test3.err
	...
	diff $(TESTDIR)/test3.out $(TESTDIR)/test3.out.expected
	diff $(TESTDIR)/test3.err $(TESTDIR)/test3.err.expected
